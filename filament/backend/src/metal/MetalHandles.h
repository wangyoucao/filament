...
public:
    ...
    MetalRenderTarget(MetalContext* context, uint32_t width, uint32_t height, uint8_t samples,
            Attachment colorAttachments[MRT::NUM_TARGETS], Attachment depthAttachment);
...
private:
    ...
    Attachment color[MRT::NUM_TARGETS] = {};
    Attachment depth = {};

    // "Sidecar" textures used to implement automatic MSAA resolve.
    id<MTLTexture> multisampledColor[MRT::NUM_TARGETS] = { 0 };
